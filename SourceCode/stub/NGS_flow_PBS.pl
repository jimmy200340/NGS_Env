...
#Run path
my $path = "/project/GP1/jimmy200340/181009_A00360_0022_AH5GJVDSXX/Unalign/NV0047";
...
chrLenFile = /project/GP1/jimmy200340/Reference/ref_hg19/genome.fa.fai
ploidy = 2
breakPointThreshold =0.08
window = 10000 
chrFiles = /project/GP1/jimmy200340/Reference/ref_hg19 
...
foreach $sample(@sample)
{
	...
	#	cmd => "cd $path/$sample/clineff ; /pkg/biology/Java/jdk_1.8.0_162/bin/java -jar ClinEff.jar -l /project/GP1/jimmy200340/license/clinEff.license -v $genome $path/$sample/StrelkaGermlineWorkflow/results/variants/variants.vcf.gz > ann.vcf",
	#);
