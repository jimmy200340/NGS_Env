...
my $run = "190415_A00360_0033_AHCV2LDSXX";
...
while ($i != 1)
{
	if (-e "/work2/jimmy200340/190415_A00360_0033_AHCV2LDSXX/CopyComplete.txt"){$i=1}
	system ("rsync -avhs pm.nhri.org.tw:/NovaSeq/a360/190415_A00360_0033_AHCV2LDSXX /work2/jimmy200340/");
	sleep 1800;
}
